...
1. At the bottom of Copilot Chat window, use the dropdown to switch to **Edit** mode.
   ...
   <img width="350" alt="image" src="https://github.com/keqingli1129/skills-getting-started-with-github-copilot/blob/main/.github/images/edit-mode-dropdown.png?raw=true" />
...
1. Ask Copilot to update our project to display the current participants of activities. Wait a moment for the edit suggestions to arrive and be applied.
   ...
   - A suggested edits panel has appeared in the bottom right of the editor window providing controls to jump to the recommended changes.
      ...
      <img width="200" alt="files with icons indicating they have been edited" src="https://github.com/keqingli1129/skills-getting-started-with-github-copilot/blob/main/.github/images/edited-files-icons.png?raw=true" />

      <img width="250" alt="edit navigation panel" src="https://github.com/keqingli1129/skills-getting-started-with-github-copilot/blob/main/.github/images/edit-navigation-panel.png?raw=true" />
